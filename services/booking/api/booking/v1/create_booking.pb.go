...
// 	protoc        (unknown)
// source: booking/v1/create_booking.proto
...
func (x *CreateBookingRequest) Reset() {
	*x = CreateBookingRequest{}
	mi := &file_booking_v1_create_booking_proto_msgTypes[0]
...
func (*CreateBookingRequest) Descriptor() ([]byte, []int) {
	return file_booking_v1_create_booking_proto_rawDescGZIP(), []int{0}
}
...
func (x *CreateBookingRoom) Reset() {
	*x = CreateBookingRoom{}
	mi := &file_booking_v1_create_booking_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBookingRoom) Descriptor() ([]byte, []int) {
	return file_booking_v1_create_booking_proto_rawDescGZIP(), []int{1}
}
...
func (x *CreateBookingResponse) Reset() {
	*x = CreateBookingResponse{}
	mi := &file_booking_v1_create_booking_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBookingResponse) Descriptor() ([]byte, []int) {
	return file_booking_v1_create_booking_proto_rawDescGZIP(), []int{2}
}
...
var File_booking_v1_create_booking_proto protoreflect.FileDescriptor

const file_booking_v1_create_booking_proto_rawDesc = "" +
	"\n" +
	"\x1fbooking/v1/create_booking.proto\x12\n" +
	"booking.v1\x1a!booking/v1/booking_messages.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bbuf/validate/validate.proto\"\xa8\x05\n" +
	...
	"\abooking\x18\x01 \x01(\v2\x13.booking.v1.BookingR\abookingB\"Z booking/api/booking/v1;bookingv1b\x06proto3"

var (
	file_booking_v1_create_booking_proto_rawDescOnce sync.Once
	file_booking_v1_create_booking_proto_rawDescData []byte
)

func file_booking_v1_create_booking_proto_rawDescGZIP() []byte {
	file_booking_v1_create_booking_proto_rawDescOnce.Do(func() {
		file_booking_v1_create_booking_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_booking_v1_create_booking_proto_rawDesc), len(file_booking_v1_create_booking_proto_rawDesc)))
	})
	return file_booking_v1_create_booking_proto_rawDescData
}

var file_booking_v1_create_booking_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_booking_v1_create_booking_proto_goTypes = []any{
...
var file_booking_v1_create_booking_proto_depIdxs = []int32{
...
func init() { file_booking_v1_create_booking_proto_init() }
func file_booking_v1_create_booking_proto_init() {
	if File_booking_v1_create_booking_proto != nil {
		return
	}
	file_booking_v1_booking_messages_proto_init()
	file_booking_v1_create_booking_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_booking_v1_create_booking_proto_rawDesc), len(file_booking_v1_create_booking_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_booking_v1_create_booking_proto_goTypes,
		DependencyIndexes: file_booking_v1_create_booking_proto_depIdxs,
		MessageInfos:      file_booking_v1_create_booking_proto_msgTypes,
	}.Build()
	File_booking_v1_create_booking_proto = out.File
	file_booking_v1_create_booking_proto_goTypes = nil
	file_booking_v1_create_booking_proto_depIdxs = nil
}
